...
namespace TestTask.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult Report(string Email)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    })
                    {
                        ...
                        {
                            ViewBag.Error = "Возникли проблемы с созданием отчета. Попробуйте еще раз или обратитесь к модератору за помощью";
                            return View();
                        }
                    }
                }
            ...
            {
                ViewBag.Error = "Возникли проблемы с отправкой письма. Попробуйте еще раз или обратитесь к модератору за помощью";
                return View();
            }
